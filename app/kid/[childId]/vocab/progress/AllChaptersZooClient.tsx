...
// ZooClient.tsx) -- same overall-completion card and plant STAGE_EMOJI
// stage set, but aggregated across every chapter's words at once instead
// of one chapter's. chapterStage/skillProgress/isWordMastered are already
// pure functions over whatever word list is passed in, so this reuses them
